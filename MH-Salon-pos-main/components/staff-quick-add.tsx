  ...
  const save = async (e: FormEvent) => {
    ...
    try {
      ...
      const record: ModuleRecord = {
        ...
        title: name,
        status: "Active",
        data: { ...form, name, phone },
        createdAt: now,
        updatedAt: now,
      };

      // The compatibility database API accepts a complete record. The ID is
      // generated by the table, so it is added to the callback object below.
